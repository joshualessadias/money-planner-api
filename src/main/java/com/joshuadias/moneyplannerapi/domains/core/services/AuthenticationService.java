...
import com.joshuadias.moneyplannerapi.domains.core.dto.requests.appUser.AuthenticationRequestDTO;
...
import static com.joshuadias.moneyplannerapi.domains.core.enums.RoleEnum.USER;
...
public class AuthenticationService {
    ...
    public AuthenticationResponseDTO authenticate(AuthenticationRequestDTO request) {
        ...
        var appUser = appUserService.findByEmailOrThrow(request.getEmail());
        var jwtToken = jwtService.generateToken(appUser);
        return AuthenticationResponseDTO.builder().token(jwtToken).build();
    }
}
